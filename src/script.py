...
if __name__ == "__main__":
    logging.info("Starting RSS feed fetcher...")  # Log instead of print
    
    # Set up the job to run every 15 minutes
    schedule.every(15).minutes.do(job)
    
    # Run once immediately at startup
    logging.info("Running initial job...")  # Log instead of print
    job()
    ...
    try:
        ...
        logging.info("Keyboard interrupt received. Exiting gracefully...") # Log instead of print